...
def Sim_update_UpdateV(time0):
    ...
    for Cell0 in CellList:
        ...
        k = get_n(Cell0 , time0) / (Cell0.Len / 1000)
        lane = Cell0.Lane
...
#    t=1
#    Sim_update_VehGen(1)   #done
#    Sim_update_UpdateInflow(1) #done
#    
#    t=2
#    Sim_update_VehGen(2)   #done
#    Sim_update_UpdateN(2) #done
#    Sim_update_VehtoW(2)    #done
#    Sim_update_UpdateW(2)   
#    Sim_update_UpdateV(2) #done
#    Sim_update_UpdateInflow(2) #done
#    
